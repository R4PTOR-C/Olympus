...
function AcademiasLogin() {
    ...
    const handleSubmit = async (event) => {
        ...
        const response = await fetch('http://localhost:5000/academias_login', {
            method: 'POST',
            headers: {
        ...
        <div className="login-page-container">
            <div className="login-container d-flex">
                <div className="col-md-6 login-form">
                    <h3 className="mb-4">Gym Sign In</h3>
                ...
                <div className="col-md-6 welcome-container">
                    ...
                    <a href="/academias" className="btn btn-outline-light">Cadastre sua academia</a>
                </div>
            </div>
        </div>
    );
