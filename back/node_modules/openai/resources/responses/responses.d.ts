 ...
 */
export type Tool = FunctionTool | FileSearchTool | ComputerTool | Tool.WebSearchTool | Tool.Mcp | Tool.CodeInterpreter | Tool.ImageGeneration | Tool.LocalShell | CustomTool | WebSearchTool;
